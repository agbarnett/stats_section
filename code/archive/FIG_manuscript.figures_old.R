...
#save
jpeg('../manuscript/figures/plos_summary.jpg',width=480,height=600,quality=100)
...
jpeg('../manuscript/figures/supplementary/plos.topicvalues.jpg',width=1000,height=800,quality=100)
g.plos.values
dev.off()
...
jpeg('../manuscript/figures/supplementary/anzctr.topicvalues.jpg',width=1000,height=800,quality=100)
g.anzctr.values
dev.off()
