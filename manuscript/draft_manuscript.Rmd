...
```{r,fig.width=10,fig.align="center",fig.cap="\\label{fig:plot-10-topics}Topic clouds summarising common terms in PLOS ONE statistical methods sections assuming ten clusters"}
