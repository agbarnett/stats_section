...
The ANZCTR was established in 2005 as part of a coordinated global effort to improve research quality and transparency in clinical trials reporting; observational studies can also be registered. All studies registered on ANZCTR are publicly available and can be searched for via an online portal. 
...
Details required for registration follow a standardised template (reference or supp file), which covers participant eligibility, intervention(s) being evaluated, study design and outcomes. Researchers are asked to provide a "brief description" of the sample size calculations, statistical methods and planned analyses, although this section is not compulsory [@ANZCTR]. 
...
There were 28,008 downloaded studies. The numbers of excluded studies are shown in Figure~X. 
Of the 12,700 eligible applications, 9523 (75%) had a statistic section. 

We examined if four study characteristics predicted a missing statistics section. The odds ratios and 95% credible intervals are in Table~X. Observational studies were less likely to have a missing methods section compared with interventional studies. Missing sections become less likely over time. Studies with more funders and a larger target sample size were less likely to have a missing methods section.  
...
Some of the statistics sections were only one word, including "ANOVA", "t-test", "SPSS" and even "SSPS". The median length of the section was 129 words with an inter-quartile range of 71 to 219 words.
...
We only examined one journal and one trial registry and hence our results may not be generalisable to all journals or registries, especially those that use a statistical reviewer.
