...
All trials registered on ANZCTR are publicly available and can be searched for via an online portal.

All studies on ANZCTR were downloaded on 1~February~2020 in XML format. Studies were excluded if the statistical methods section was empty or labelled as "Not applicable", "Nil" or "None". 
...
* Final sample size
* Breakdown of included articles by year of publication (did/did not include stats section). Final sample broken down by subject classification(s) [most are biology and life sciences]
* Figure showing change in gof measure as function of number of clusters (use to justify choice of number of clusters)

* Desribe topic clusters + examples
