...
Details required for registration follow a standardised template (reference or supp file), which covers participant eligibility, intervention(s) being evaluated, study design and outcomes. Researchers are asked to provide a "brief description" of the sample size calculations, statistical methods and planned analyses, although this section is not compulsory [@ANZCTR]. All information must be in English. Studies are reviewed by ANZCTR staff, but are not peer reviewed. 
