...
Expanded descriptions of between-group analysis were found in three topics (4, 6 and 10), varying based on method(s) used and study design (Box 3). [TODO: link to topics 1 and 9 here]Statistical methods sections associated with Topic 4 (n = 10,163) combined descriptive statistics followed by Student's t-test and/or one-way analysis of variance with post-hoc multiple comparisons.  Descriptive statistics were commonly reported as means with standard deviations or standard errors. Topic 6 (n = 4,746) followed a similar template minus multiple comparisons. Topic 10 (Topic 10: n = 4,664) concentrated on between-group analysis applied to experimental replicates.
