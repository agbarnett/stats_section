...
The ANZCTR was established in 2005 as part of a coordinated global effort to improve research quality and transparency in clinical trials reporting. All trials registered on ANZCTR are publicly available and can be searched for via an online portal. Researchers responsible for overseeing a clinical trial are expected to register full details before commencing participant enrolment. Details required for registration follow a standardised template (reference or supp file), which covers important details about participant eligibility, intervention(s) being evaluated, study design and outcomes. Researchers are asked to provide a "brief description" of the sample size calculations, statistical methods and planned analyses, but this section is not compulsory [@ANZCTR]. 
